    ...
    <div className="flex-colo gap-4">
      ...
      {titles && (
        <div className="flex w-full flex-col gap-3">
          <p className="text-black text-sm">Titulo</p>
          <Select
      ...
      {/* phone */}
      <Input label="Numero de telefono" color={true} type="number" />
      {/* email */}
      <Input label="Correo" color={true} type="email" />
      {!titles && (
        <>
          {/* gender */}
          <div className="flex w-full flex-col gap-3">
            <p className="text-black text-sm">Genero</p>
            <Select
