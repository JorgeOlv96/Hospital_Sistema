  ...
  return (
    <Layout>
      ...
      <div className=" grid grid-cols-12 gap-6 my-8 items-start">
        ...
        >
          <div className="w-40 h-40 rounded-full border border-dashed border-subMain flex items-center justify-center">
            <FontAwesomeIcon icon={faUser} size="3x" />
          </div>

          <div className="gap-2 flex-colo">
            <h2 className="text-sm font-semibold">Dr. Arriaga</h2>
            <p className="text-xs text-textGray">arriaga@gmail.com</p>
