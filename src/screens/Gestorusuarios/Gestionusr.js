...
function Gestionusuarios() {
    ...
    const handleSave = async (e) => {
        e.preventDefault();
        const { id_usuario, nombre, ap_paterno, ap_materno, nivel_usuario, email, cedula } = userToEdit;
        ...
        try {
            ...
            if (!response.ok) {
                ...
                setUsuarios(usuarios.map((user) => (user.id_usuario === id_usuario ? updatedUser : user)));
                setShowModal(false);
